...
Перед тем как установить, надо изменить config/hypr/hyprland.conf, строку про мониторы под ваше. Чтобы посмотреть наиишите в терминале hyprctl monitors all.
